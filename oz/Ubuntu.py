...
class UbuntuGuest(oz.Linux.LinuxCDGuest):
    """
    Class for Ubuntu 5.04, 5.10, 6.06, 6.10, 7.04, 7.10, 8.04, 8.10, 9.04, 9.10, 10.04, 10.10, 11.04, 11.10, 12.04, 12.10, 13.04, 13.10, 14.04, 14.10, 15.04, 15.10, 16.04 installation.
    """
...
""")
                ...
                if os.path.isdir(os.path.join(self.iso_contents, "casper")):
                    ...
                    if self.tdl.update in ["12.04.2", "12.04.3", "12.04.4",
                                           ...
                                           "14.04.1", "14.10", "15.04", "15.10", "16.04"] and self.tdl.arch == "x86_64":
                        kernelname += ".efi"
...
def get_class(tdl, config, auto, output_disk=None, netdev=None, diskbus=None,
    ...
    if tdl.update in ["9.10", "10.04", "10.04.1", "10.04.2", "10.04.3", "10.10",
                      ...
                      "13.10", "14.04", "14.04.1", "14.10", "15.04", "15.10", "16.04"]:
        if netdev is None:
            netdev = 'virtio'
        if diskbus is None:
            diskbus = 'virtio'
